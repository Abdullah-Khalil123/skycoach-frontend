      ...
      <div className="w-full md:flex justify-between mb-4 gap-4">
        <div>
          <div className="flex gap-4 mb-8">
            <button className="flex gap-2 items-center bg-secondary px-4 py-2 text-lg font-semibold rounded-md">
              Chat with us
          ...
          <div className="text-secondary-text font-semibold mb-4">
            <p className="mb-2">
        ...
        <div>
          <button className="h-12 w-fit text-nowrap flex gap-2 items-center bg-secondary px-4 py-2 text-lg font-semibold rounded-md">
            Chat with us
            <MessageCircleMore size={20} />
          </button>
          <div className="flex flex-col mt-6 gap-8 text-secondary-text font-semibold">
